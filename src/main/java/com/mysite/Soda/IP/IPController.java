...
public class IPController {
	...
	@PostMapping("/IpSave")
	@ResponseBody
	public IPafterVO updateIPMem(@RequestParam(name = "ipaddress") String ipaddress,
			@RequestParam(name = "ipexplain") String ipexplain) {
		Object memIdobj = session.getAttribute("memberId");
		int member_id = (int) memIdobj;
	...
	@ResponseBody
	public IPafterVO updateLoginIPMem(@RequestParam(name = "ipaddress") String ipaddress,
			@RequestParam(name = "ipexplain") String ipexplain) {
		Object memIdobj = session.getAttribute("memberId");
		int member_id = (int) memIdobj;
